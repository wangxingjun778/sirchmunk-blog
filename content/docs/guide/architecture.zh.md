...
Sirchmunk 的架构被组织为清晰分离的层次，遵循**关注点分离**原则。
...
![蒙特卡洛证据采样算法](Sirchmunk_MonteCarloSamplingAlgo.png "蒙特卡洛证据采样：三幕式探索-利用策略")

1. **第一幕 — 撒网**：模糊锚定 + 分层随机采样
2. **第二幕 — 聚焦**：围绕高分种子的高斯重要性采样
3. **第三幕 — 合成**：Top-K 片段 → LLM 摘要
